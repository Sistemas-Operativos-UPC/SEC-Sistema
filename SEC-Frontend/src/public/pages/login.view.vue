...
function saveInStore(response){
  authStore.setAuth('tokenDefault');
...
function IsValid() {
  return email.value.length > 0 && password.value.length > 0 && email.value !== '' && password.value !== '';
}
      ...
      <template #content>
        <div class="sections">
          <div class="section sign-in-section">
            ...
            <form class="form" @submit.prevent="onSubmit">
              <pv-floatlabel class="w-full">
                <pv-inputtext class="w-full my-2" id="email" v-model="email" fluid/>
          ...
          <div class="section sign-up-section">
            <div class="content">
              <h1>Conectando Zonas con el Saber</h1>
              <p>Facilita la colaboración y comparte recursos educativos entre instituciones para transformar la educación en comunidades rurales. ¡Únete al cambio!</p>
