...
function IsValid() {
  return email.value.length > 0 && password.value.length > 0 && role.value.length > 0 && password.value === repeatPassword.value && name.value.length > 0;
}
      ...
      <template #content>
        <div class="sections">
          <div class="section sign-up-section">
            <div class="content">
              <h1>Únete y Transforma la Educación</h1>
              <p>Facilita la gestión y comparte recursos educativos para impulsar el aprendizaje en comunidades rurales. Regístrate hoy y contribuye al cambio.</p>
          ...
          <div class="section sign-in-section">
            ...
            <form class="form" @submit.prevent="onSubmit">
              <pv-floatlabel class="w-full">
                <pv-select class="w-full my-2" v-model="role" :options="['student', 'teacher', 'parent', 'principal']"  fluid/>
                <label for="email">Role</label>
              </pv-floatlabel>
              <pv-floatlabel class="w-full">
                <pv-inputtext class="w-full my-2" v-model="name" fluid/>
                <label for="email">Name</label>
              </pv-floatlabel>
              <pv-floatlabel class="w-full">
                <pv-inputtext class="w-full my-2" v-model="email" fluid/>
